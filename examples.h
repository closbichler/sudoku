...
#define sudoku_example_no_solutions(s)                      \
    ...
    {                                                     \
        *(s) = (Sudoku) sudoku_create_empty(9, 3);        \
        (s)->field[0] = (char[]) { 1,0,6, 0,0,0, 0,0,3 }; \
        (s)->field[1] = (char[]) { 0,1,0, 0,0,0, 0,0,0 }; \
        (s)->field[2] = (char[]) { 7,0,1, 0,4,8, 0,6,0 }; \
        (s)->field[3] = (char[]) { 0,7,0, 1,0,0, 0,0,0 }; \
        (s)->field[4] = (char[]) { 0,4,0, 2,1,5, 0,0,9 }; \
        (s)->field[5] = (char[]) { 2,0,0, 0,8,1, 0,5,7 }; \
        (s)->field[6] = (char[]) { 5,0,8, 0,3,0, 1,0,0 }; \
        (s)->field[7] = (char[]) { 0,0,0, 0,0,0, 3,1,0 }; \
        (s)->field[8] = (char[]) { 3,0,0, 0,0,0, 5,4,1 }; \
    } while (0)
...
#define sudoku_example_wrong(s)                           \
    ...
    {                                                     \
        *(s) = (Sudoku) sudoku_create_empty(9, 3);        \
        (s)->field[0] = (char[]) { 1,2,3, 4,7,9, 8,6,5 }; \
        (s)->field[1] = (char[]) { 4,7,6, 3,8,5, 9,2,1 }; \
        (s)->field[2] = (char[]) { 9,5,8, 6,2,1, 7,3,4 }; \
        (s)->field[3] = (char[]) { 2,8,1, 9,4,6, 5,7,3 }; \
        (s)->field[4] = (char[]) { 6,9,4, 7,5,3, 1,8,2 }; \
        (s)->field[5] = (char[]) { 7,3,5, 8,1,2, 6,4,9 }; \
        (s)->field[6] = (char[]) { 3,4,9, 5,6,8, 2,1,7 }; \
        (s)->field[7] = (char[]) { 8,1,7, 2,9,4, 3,5,6 }; \
        (s)->field[8] = (char[]) { 5,6,2, 1,3,7, 4,9,2 }; \
    } while (0)
